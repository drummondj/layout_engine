...
/// Raw Dart FFI bindings for backend/src/api/api.hpp, the Layout Engine
...
///
class LayoutEnginePluginBindings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
  _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  LayoutEnginePluginBindings(ffi.DynamicLibrary dynamicLibrary)
    : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  LayoutEnginePluginBindings.fromLookup(
  ...
  LeInstanceId le_create_instance(
    ...
    LeDesignId reference_design_id,
    ffi.Pointer<ffi.Char> name,
...
enum LeObjectKind {
  ...
  static LeObjectKind fromValue(int value) => switch (value) {
    ...
    7 => LE_OBJECT_KIND_ROW,
    8 => LE_OBJECT_KIND_PLACEMENT,
    9 => LE_OBJECT_KIND_BLOCKAGE,
    10 => LE_OBJECT_KIND_ROUTE,
    11 => LE_OBJECT_KIND_PHYSICAL_PORT,
    12 => LE_OBJECT_KIND_REGION,
    13 => LE_OBJECT_KIND_PHYSICAL_PORT_SEGMENT,
    14 => LE_OBJECT_KIND_LAYOUT,
