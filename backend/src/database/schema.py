...
schema = Schema(
    ...
    classes=[
        ...
        Klass(
            name="Blockage",
            description="A routing or placement blockage (DEF BLOCKAGES) - one klass for both kinds, mirroring how the vendored parser's own defiBlockage struct covers both",
            fields=[
        ...
        Klass(
            ...
            fields=[
                ...
                Field(name="name", description="The name of the region - unique within its parent Layout (see unique_per_parent)", type="str", example="region1", index=True, unique_per_parent=True),
