    ...
    classes=[
        Klass(
            ...
            fields=[
                ...
                Field(
                    name="fin_pitch",
                    description="FinFET grid pitch, in database units - overrides the pitch of a LIBRARY LEF58_FINFET property; unset means use that property's",
                    type="dbu",
                    example=48,
                    is_optional=True,
                ),
        ...
        Klass(
            ...
            fields=[
                ...
                Field(
                    name="layout_via",
                    description="Owning LayoutVia, if this ViaLayer belongs to one (unset/invalid otherwise)",
                    type="LayoutVia",
                    parent="layers",
                ),
                Field(
        ...
        Klass(
            ...
            fields=[
                Field(
                    name="via",
                    description="Owning Via, if this ViaRuleReference belongs to one (unset/invalid otherwise)",
                    type="Via",
                    parent="via_rule",
                ),
                Field(
                    name="layout_via",
                    description="Owning LayoutVia, if this ViaRuleReference belongs to one (unset/invalid otherwise)",
                    type="LayoutVia",
                    parent="via_rule",
                ),
                Field(
                ...
                Field(
                    name="num_cut_rows",
                    description="Number of cut rows (LEF ROWCOL) - unset means a single cut",
                    type="int",
                    example=2,
                    is_optional=True,
                ),
                Field(
                    name="num_cut_cols",
                    description="Number of cut columns (LEF ROWCOL) - unset means a single cut",
                    type="int",
                    example=2,
                    is_optional=True,
                ),
        ...
        Klass(
            ...
            fields=[
                ...
                Field(
                    name="blockage",
                    description="Owning Blockage, if this Shape belongs to one (unset/invalid otherwise)",
                    type="Blockage",
                    parent="shapes",
                ),
                Field(
                ...
                Field(
                    name="abstract",
                    description="Owning Abstract, if this Shape is that Abstract's boundary - unset otherwise",
                    type="Abstract",
                    parent="boundary",
                ),
                Field(
                ...
                Field(
                    name="spacing",
                    description="LEF LAYER ... SPACING (OBS/PORT minimum-spacing override), in database units - unset means the layer's own rules apply; 0 is a real value. Mutually exclusive with design_rule_width.",
                    type="dbu",
                    example=1500,
                    is_optional=True,
                ),
                Field(
                    ...
                    description="LEF LAYER ... DESIGNRULEWIDTH, in database units - unset means none; 0 is a real value. Mutually exclusive with spacing.",
                    type="dbu",
                    example=1500,
                    is_optional=True,
                ),
        ...
        Klass(
            ...
            fields=[
                ...
                Field(name="width", description="The width of the DEF routed path at this via, in database units - used to size a VIARULE GENERATE via's cut array; unset for a LEF PORT/OBS via", type="dbu", is_optional=True),
            ],
        ),
        Klass(
        ...
        Klass(
            ...
            fields=[
                ...
                Field(
                    name="layout_via",
                    description="Owning LayoutVia, if this Foreign belongs to one (unset/invalid otherwise)",
                    type="LayoutVia",
                    parent="foreign",
                ),
                Field(
        ...
        Klass(
            ...
            fields=[
                ...
                Field(name="weight", description="DEF COMPONENTS WEIGHT - unset if omitted", type="double", example=1.0, is_optional=True),
        ...
        Klass(
            ...
            fields=[
                ...
                Field(name="placement_max_density", description="PLACEMENT ... PARTIAL maxDensity (0-100) - unset if not PARTIAL", type="double", is_optional=True),
        ...
        Klass(
            ...
            fields=[
                ...
                Field(name="use", description="SIGNAL, POWER, GROUND, CLOCK, ... or unset (DEF NETS/SPECIALNETS USE)", type="str", example="POWER", is_optional=True),
        ...
        Klass(
            ...
            fields=[
                ...
                Field(name="region_type", description="FENCE or GUIDE - unset if omitted (DEF REGIONS TYPE)", type="str", example="FENCE", is_optional=True),
